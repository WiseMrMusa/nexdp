...
import { TemplateElement } from "@/lib/api";
...
export default function TemplateEditor({ onSave, initialTemplate }: TemplateEditorProps) {
  ...
  const handleAddConfigArea = (type: "image" | "text") => {
    const newArea = {
      ...
      url: type === "image" ? "https://picsum.photos/200" : undefined,
    };
  ...
  const handleSaveTemplate = () => {
    const elements: TemplateElement[] = configAreas.map(area => ({
      type: area.type,
